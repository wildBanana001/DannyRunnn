...
function assertFulfillableOrder(order) {
...
export async function confirmShopOrderFulfillment(orderId, adminOpenid) {
    ...
    try {
        ...
        throw new OrderFulfillmentError('WECHAT_SHIPPING_REPORT_FAILED', `${message}；到店交付已记录，可在订单管理中重试上报`, 502, failed || claim.order);
    }
}
