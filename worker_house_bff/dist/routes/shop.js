...
import { createOrder, getOrderByClientRequestId, getOrderById, getOrdersByOpenid, updateOrderPayment, updateOrderStatus, } from '../data/orders.js';
import { wxCloudrunAuth } from '../middlewares/wx-cloudrun-auth.js';
import { buildJsapiPayParams, closeWechatPayOrder, createOutTradeNo, decryptNotifyResource, isWechatPayConfigured, jsapiUnifiedOrder, queryWechatPayOrder, verifyWechatPaySignature, WechatPayApiError, } from '../utils/wechat-pay.js';
...
function applyWechatOrderState(order, result) {
