...
const defaultRecord: SiteConfigRecord = {
  communityQrcode: '',
...
const siteConfigStore: SiteConfigStoreState = {
  record: null,
};
...
function normalizeRecord(record?: Partial<SiteConfigRecord> | null) {
  return {
...
function loadSiteConfig() {
  ...
  try {
    ...
    const parsed = JSON.parse(rawContent) as Partial<SiteConfigRecord> | null;
...
export function updateSiteConfig(input: Partial<SiteConfigRecord>, updatedBy: string) {
  loadSiteConfig();
