  ...
  const storyCards: StoryCardItem[] = useMemo(() => {
    if (stories.length > 0) {
      return stories.slice(0, 3).map((story, index) => ({
        ...
        title: story.title,
        image: story.cover,
        fallbackImage: HOME_ASSETS.stories[index % HOME_ASSETS.stories.length].image,
        story,
      }));
    }
        ...
        <View className={styles.pageShell} style={enterStyle}>
          <View className={styles.heroSection}>
            <View className={styles.heroTopRow}>
              ...
              <Image className={styles.heroSpark} src={HOME_ASSETS.spark} mode="aspectFit" />
            </View>
            <View className={styles.heroCard}>
              {heroSlides.length > 0 && !heroRemoteFailed ? (
                ...
                <Image className={styles.heroImage} src={HOME_ASSETS.hero} mode="aspectFit" lazyLoad />
              )}
            </View>
          ...
          <View className={`${styles.section} ${styles.moreSection}`}>
            <View className={styles.moreTitleBar}>
              <Image className={styles.moreDividerImage} src={HOME_ASSETS.divider} mode="scaleToFill" />
              <Image className={styles.moreTitleImage} src={HOME_ASSETS.text.moreActivities} mode="aspectFill" />
            </View>
                ...
                <View className={styles.activityList}>
                  {moreActivities.map((activity) => (
                    ...
                    >
                      ...
                      <ArrowRight className={styles.activityArrow} size="18" />
                    </View>
                  ))}
                </View>
          ...
          <View className={`${styles.section} ${styles.aprilSection}`}>
            <View className={styles.aprilHeading}>
            ...
            <View className={styles.aprilCollageStage}>
              <SafeImage className={styles.aprilCollage} src={HOME_ASSETS.april} mode="widthFix" lazyLoad />
            </View>
                ...
                >
                  {spaceImages.map((image) => (
                    <SwiperItem key={image}>
                      <SafeImage className={styles.spaceImage} src={image} fallbackSrc={HOME_ASSETS.spaceFallback} fallbackDelayMs={1800} mode="aspectFill" lazyLoad />
                    </SwiperItem>
                  ))}
                </Swiper>
              ) : (
            ...
            <View className={styles.storyList}>
              {storyCards.map((item) => (
                <View key={item.id} className={styles.storyCard} onClick={() => handleStoryCardTap(item)}>
                  <SafeImage className={styles.storyImage} src={item.image} fallbackSrc={item.fallbackImage} fallbackDelayMs={1800} mode="aspectFill" lazyLoad />
